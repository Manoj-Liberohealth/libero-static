...
export default () => {
  ...
  return (
    <AnimationRevealPage>
        <Helmet>
        <title>Libero Health Patients</title>
        ...
        <meta name="keywords" content="Telehealth, Electronic health record, Electronic prescription, connected health platform, Patient centred, Patient centric"/>
      </Helmet>
      <Header />
      <MainFeature1
      subheading={false}
