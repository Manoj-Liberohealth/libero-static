        ...
        <FiveColumns>
          ...
          <Column>
            ...
            <LinkList>
              ...
              <LinkListItem>
                <Link to="/business-partner" onClick={gaEvents(" business partner",window.location.pathname)}>For Business Partners</Link>
              </LinkListItem>
              <LinkListItem>
                <Link to="/healthcare-provider" onClick={gaEvents(" healthcare provider",window.location.pathname)}>For Healthcare Providers</Link>
              </LinkListItem>
              <LinkListItem>
                <Link to="#"></Link>
              </LinkListItem>
